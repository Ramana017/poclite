...
export class AmsAlertsServiceService {
  ...
  public loginDetails;
  public getUrl() {
    this.amsAlertUrl = sessionStorage.getItem('amsWebserviceURL');
  ...
  public authenticateUserForDevices(): Observable<any> {
    ...
    return this.http.get(`${this.amsAlertUrl}/authenticateUserForDevices?username=${this.loginDetails.username}&password=${this.loginDetails.password}&deviceId="IA2B3C4D5E6F7G8H"`).pipe(catchError(this.errorHandler));
  }
  ...
  public getAlertsForDevices(userId, startDate, endDate, searchBy, viewByFlag, applicationId, alertDefinitionId, sessionId): Observable<any> {
    ...
    return this.http.get(`${this.amsAlertUrl}getAlertsForDevices?userId=${userId}&startDate=${startDate}&endDate=${endDate}&searchByKeyword=${searchBy}&viewByFlag=0&applicationId=${applicationId}&alertDefinitionId=${alertDefinitionId}&sessionId=${sessionId}`).pipe(catchError(this.errorHandler));
  }
